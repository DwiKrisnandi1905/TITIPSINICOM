...
@section('content')
    ...
    <div class="container-beranda">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" style="margin-bottom: 36px;">
                    ...
                    <h2 class="font-weight-bold" style="font-size: 56px; font-weight: 700"><span
                            style="color: #068113">Titipsini</span> aja!</h2>
                ...
                <div class="col-md-6">
                    <img src="{{ asset('/img/beranda-1.png') }}" class="img-fluid" alt="Gambar Layanan"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="{{ asset('/img/beranda-2.png') }}" class="img-fluid" alt="Gambar Layanan"
                        style="margin-top: -50px;">
                </div>
            ...
            <div class="row">
                <div class="col-12 text-center" style="padding: 32px 0;">
                    <h2 class="font-weight-bold" style="font-size: 36px; font-weight: 700">Tunggu Apalagi?<br> Ayo Buruan
                        Download Titipsini Sekarang!</h2>
