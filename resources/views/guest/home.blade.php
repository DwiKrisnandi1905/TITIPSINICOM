...
@section('content')
    <div class="wrapper">
        ...
        <section>
            <div class="container-beranda-1">
                <div class="kolom-1">
                    ...
                    <p style="margin-bottom: 50px; margin-top: 30px">Semua bisa dititipkan termasuk barang, rumah atau
                        kendaraan.</p>
                    <a href="#" class="btn-beranda-1">Download Sekarang</a>
                </div>
                <img src="{{ asset('/img/beranda-1.png') }}" width="400px" lenght="400px"
        ...
        <section>
            <div class="container-beranda-1">
                <img src="{{ asset('/img/beranda-2.png') }}" width="700px" lenght="500px"
                    style="margin-top: -50px; margin-right: 30px" />
                <div class="kolom-2">
        ...
        <section>
            <div class="container-beranda-1">
                ...
                <img src="{{ asset('/img/beranda-3.png') }}" width="600px" lenght="600px"
        ...
        <section>
            <div class="container-beranda-1">
                <img src="{{ asset('/img/beranda-4.png') }}" width="700px" lenght="500px"
                    style="margin-top: 50px; margin-left: -50px" />
                <div class="kolom-4">
                    <h2 style="font-weight:700; font-size: 36px">Promo Cashback 30%</h2>
                    <p style="margin-bottom: 50px; margin-top: 24px">Khusus pengguna baru tersedia promo <span
                            style="font-weight: 700;">cashback</span> <br> besar-besaran.</p>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container-beranda-2">
                ...
                <h2 style="font-weight:700; font-size: 32px">Ayo Buruan Download <span
                        style="color: #068113">Titipsini</span> Sekarang!</h2>
