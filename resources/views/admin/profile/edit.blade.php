...
<style>
    ...
    .ubah-button {
    padding: 3px 80px;
    background-color: #299935; /* Warna latar belakang */
        ...
        <div class="col-md-6">
            <div class="profile-info">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama lengkap" name="nama" value="Yusuf Siregar">
                </div>
                <div class="form-group">
                    <label for="nama">Alamat</label>
                    <input type="text" class="form-control" id="alamat" name="nama" value="Banguntapan">
                </div>
                <div class="form-group">
                    <label for="nama">Provinsi</label>
                    <input type="text" class="form-control" id="Provinsi" name="nama" value="Daerah Istimewa Yogyakarta">
                </div>
                <div class="form-group">
                    <label for="nama">Kabupaten/Kota</label>
                    <input type="text" class="form-control" id="kab" name="nama" value="Kabupaten Sleman">
                </div>
                <div class="form-group">
                    <label for="nama">Kecamatan</label>
                    <input type="text" class="form-control" id="Kecamatan" name="nama" value="Depok">
                </div>
                <div class="form-group">
                    <label for="nama">Kode Pos</label>
                    <input type="text" class="form-control" id="nama" name="nama" value="55198">
                </div>
                <div class="buttonubah">
                    <button class="ubah-button" onclick="goBack()">Simpan</button>
                </div>
            </div>
        </div>
    </div>
