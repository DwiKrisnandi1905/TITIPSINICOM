...
<div class="container-syarat">
    ...
    <ul class="number-list">
        ...
        <li>“Penjual” berarti Pengguna yang menggunakan Platform untuk menampilkan dan menawarkan Barang dan/atau Jasa kepada Pembeli.</li>
        <li>“Penyedia Jasa Pembayaran” berarti penyedia jasa pembayaran pihak ketiga yang bekerja sama dengan Titipsini untuk memproses, mentransmisikan, dan memfasilitasi metode pembayaran di Platform</li>
        <li>“Platform” berarti aplikasi seluler Titipsini, termasuk teknologi atau perangkat lunak Titipsini lainnya yang akan dikembangkan dari waktu ke waktu oleh TitipGroup.</li>
        <li>“Jasa” berarti semua jasa yang ditawarkan untuk disediakan oleh Penjual.</li>
    </ul>
    Istilah “Titipgroup”, “Titipsini”, “kami” dan “milik kami” berarti PT Titipgroup Financial Indonesia dan, dalam setiap hal, termasuk anak perusahaan dan afiliasinya. <br><br>

    <strong>Penerimaan Ketentuan Penggunaan</strong><br><br>

    Anda memahami, menyetujui, dan mengakui bahwa Ketentuan Penggunaan ini merupakan perjanjian yang mengikat secara hukum antara Anda dan TitipGroup dan bahwa penggunaan Anda atas Platform akan menunjukkan penerimaan konklusif Anda atas Ketentuan Penggunaan ini. <br><br>

    Kami dapat sewaktu-waktu merilis jasa, perangkat, dan fitur baru di Platform. Penggunaan Anda atas setiap jasa baru kami akan diatur oleh Ketentuan Penggunaan ini sejak jasa baru tersebut tersedia. <br><br>

    Jika Anda tidak setuju dengan Ketentuan Penggunaan ini, Anda harus berhenti mengakses atau menggunakan Platform. Anda setuju dan berjanji untuk menonaktifkan atau menghapus akun Anda dari Platform jika Anda tidak setuju dengan Ketentuan Penggunaan ini. <br><br>

    Anda bertanggung jawab penuh atas semua akses ke Platform (termasuk setiap akses yang dilakukan oleh orang lain) yang menggunakan akun Anda. Jika Anda menggunakan Platform sebagai karyawan atau wakil dari suatu perusahaan atau organisasi, Anda menyatakan dan menjamin bahwa Anda adalah orang yang berwenang dari perusahaan atau organisasi tersebut atau berwenang untuk mewakili perusahaan atau organisasi tersebut, dan Anda menyetujui Ketentuan Penggunaan ini atas nama perusahaan atau organisasi tersebut. <br><br>

    Anda menyatakan dan menjamin bahwa Anda diizinkan oleh semua peraturan perundang-undangan yang berlaku untuk mengunjungi, atau melihat, mengakses atau menggunakan fitur, perangkat dan/atau jasa apa pun yang tersedia di Platform, dan memiliki kapasitas hukum serta otorisasi yang diperlukan (termasuk persetujuan dari orang tua atau wali sah Anda untuk Pengguna yang berusia di bawah 18 (delapan belas) tahun) untuk mengikatkan diri Anda pada Ketentuan Penggunaan ini. <br><br>
