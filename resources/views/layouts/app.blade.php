            ...
            <div class="row">
                ...
                <div class="col-md">
                    <ul class="list-unstyled nav-links">
                        ...
                        <li><a href="{{ route('home.syarat-ketentuan') }}">Syarat & Ketentuan</a></li>
                        <li><a href="{{ route('home.privacy-policy') }}">Kebijakan Privasi</a></li>
                ...
                <div class="col-md text-md-center">
                    <a href="#">
                        <img src="{{ asset('/img/getplay.png') }}" alt="Google Play"
